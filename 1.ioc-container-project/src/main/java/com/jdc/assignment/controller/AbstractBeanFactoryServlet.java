...
public abstract class AbstractBeanFactoryServlet extends HttpServlet implements BeanFactoryServlet{
	...
	public <T> T getBean(String name, Class<T> requiredType) throws BeansException {
		var spring = getServletContext().getAttribute(SpringContainerManager.SPRING_CONTEXT);// getServletContext() is Servlet Application Context and get Spring Context from Servlet Application Context
