...
public class ClassService {
	...
	public ClassForm findById(int id) {
		return template.queryForObject("select id, teacher_id teacher, start_date startDate, months, description from classes where id = :id", Map.of("id", id), new BeanPropertyRowMapper<>(ClassForm.class));
	}
