...
public class StudentService {
	...
	public StudentDetailsVO findDetailsByLoginId(String email) {
		...
		var studentDetailsVo = new StudentDetailsVO();
		
		var studentId = findStudentByEmail(email);
		
		studentDetailsVo.setStudent(findInfoById(studentId));
		studentDetailsVo.setRegistrations(registrationService.searchByStudentId(studentId));
